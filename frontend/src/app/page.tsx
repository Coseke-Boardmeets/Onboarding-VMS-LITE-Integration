...
export default function MainAppPage() {
  ...
  async function handleCheckIn(id: string) {
    ...
    try {
      ...
      setActionError(err instanceof Error ? err.message : "Check-in failed. Try again.");
    }
  }
  ...
  async function handleCheckOut(id: string) {
    ...
    try {
      ...
      setActionError(err instanceof Error ? err.message : "Check-out failed. Try again.");
    }
  }
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-slate-200 bg-white/95 dark:border-slate-800/60 dark:bg-slate-900/95 p-6 shrink-0 transition-all duration-200">
        ...
        <div className="border-t border-slate-200/60 dark:border-slate-800/60 pt-6 space-y-4">
          ...
          <div className="flex flex-col space-y-2 p-3 rounded-xl bg-slate-50 dark:bg-slate-950/40 border border-slate-205 dark:border-slate-800/50">
            ...
            <button
              onClick={logout}
              className="mt-2 w-full flex items-center justify-center space-x-1.5 py-1.5 px-3 rounded-lg border border-slate-200 dark:border-slate-800 text-xs font-bold text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-955/20 active:scale-[0.98] transition-all cursor-pointer"
            >
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-700 dark:text-slate-300 font-bold">Theme</span>
            <button
              onClick={toggleTheme}
          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-1 md:hidden bg-slate-200 dark:bg-slate-850 p-1 rounded-xl">
              <button
                ...
                className={`px-3 py-1.5 text-xs font-bold rounded-lg ${
                  activeTab === "DASHBOARD" ? "bg-white text-slate-950 dark:bg-slate-800 dark:text-white" : "text-slate-655"
                }`}
              >
                Desk
              </button>
              <button
                onClick={() => setActiveTab("STATISTICS")}
                className={`px-3 py-1.5 text-xs font-bold rounded-lg ${
                  activeTab === "STATISTICS" ? "bg-white text-slate-955 dark:bg-slate-800 dark:text-white" : "text-slate-655"
                }`}
              >
                Stats
              </button>
            ...
            <div className="hidden md:block">
              <span className="text-xs font-extrabold uppercase tracking-widest text-blue-700 dark:text-blue-400">
                {activeTab === "DASHBOARD" ? "Reception Control Center" : "Analytics Operations"}
              </span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                {theme === "light" ? <DarkModeIcon className="h-4 w-4" /> : <LightModeIcon className="h-4 w-4" />}
              </Button>

              {/* Mobile Logout (mobile only) */}
              <Button
                variant="outline"
                size="sm"
                onClick={logout}
                className="md:hidden border-slate-300 text-rose-600 hover:bg-rose-50 dark:border-slate-750 dark:text-rose-400 dark:hover:bg-rose-955/20 px-3 rounded-lg"
              >
              ...
              <Button asChild size="sm" className="bg-blue-700 hover:bg-blue-800 text-white font-bold shadow-md shadow-blue-700/20 rounded-lg">
                <Link href="/register">
          ...
          <div className="mx-auto max-w-6xl space-y-8">
            ...
            <div>
              <h2 className="text-3xl font-extrabold tracking-tight text-slate-955 dark:text-white">
                {activeTab === "DASHBOARD" ? "On-Site Visitor Logs" : "Visitor Activity Statistics"}
              </h2>
            ...
            {actionError && (
              <div role="alert" className="flex items-center space-x-2 rounded-xl bg-rose-50 border border-rose-200 p-4 text-sm text-rose-900 dark:bg-rose-955/20 dark:border-rose-900/30 dark:text-rose-450">
                <ErrorOutlinedIcon className="h-5 w-5 text-rose-605 shrink-0" />
                <span>{actionError}</span>
              </div>
            )}
            {successNotification && (
              <div role="alert" className="flex items-center space-x-2 rounded-xl bg-emerald-50 border border-emerald-200/80 p-4 text-sm text-emerald-900 dark:bg-emerald-955/20 dark:border-emerald-900/30 dark:text-emerald-450 animate-fadeIn">
              ...
              <>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-md dark:border-slate-800/40 dark:bg-slate-900 hover:shadow-lg transition-all">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-extrabold uppercase tracking-wider text-slate-500 dark:text-slate-400">Total Visits</span>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-semibold">Overall registered guests</p>
                    </div>
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-md dark:border-slate-800/40 dark:bg-slate-900 hover:shadow-lg transition-all">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-extrabold uppercase tracking-wider text-slate-500 dark:text-slate-400">Currently Inside</span>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-semibold">Checked-in status</p>
                    </div>
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-md dark:border-slate-800/40 dark:bg-slate-900 hover:shadow-lg transition-all">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-extrabold uppercase tracking-wider text-slate-500 dark:text-slate-400">Pending Arrival</span>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-semibold">Awaiting arrival</p>
                    </div>
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-md dark:border-slate-800/40 dark:bg-slate-900 hover:shadow-lg transition-all">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-extrabold uppercase tracking-wider text-slate-500 dark:text-slate-400">Checked Out</span>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-semibold">Completed visits</p>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center space-x-1 overflow-x-auto p-1.5 rounded-xl bg-slate-200 dark:bg-slate-900 border border-slate-300/30">
                      {["ALL", "PENDING", "CHECKED_IN", "CHECKED_OUT"].map((filter) => {
                  ...
                  {loading ? (
                    <div className="flex flex-col items-center justify-center py-20 bg-white/50 border border-slate-200 dark:border-slate-850 rounded-2xl">
                      ...
                      <span className="text-sm font-semibold text-slate-755 dark:text-slate-300 mt-3">Loading visitor logs...</span>
                    </div>
                  ) : error ? (
                    ...
                    <div className="text-center py-20 bg-white/70 border border-slate-200 rounded-2xl shadow dark:border-slate-805 dark:bg-slate-950/40 text-slate-800">
                      ...
                      <h4 className="text-base font-extrabold text-slate-955 dark:text-slate-100 mb-1">No visitors found</h4>
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200 dark:from-blue-950/20 dark:to-blue-950/10 dark:border-blue-900 p-5 rounded-2xl shadow-sm">
                    <span className="text-2xs font-extrabold uppercase text-blue-700 dark:text-blue-305 tracking-wider">Visits Today</span>
                    <h4 className="text-3xl font-extrabold text-blue-955 dark:text-white mt-1">
                      {statsLoading ? "..." : stats?.summary.today ?? 0}
                    </h4>
                    <p className="text-xs text-blue-800 dark:text-blue-400 font-semibold mt-1">Guests welcomed since 12:00 AM</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 border border-emerald-200 dark:from-emerald-950/20 dark:to-emerald-950/10 dark:border-emerald-900 p-5 rounded-2xl shadow-sm">
                    <span className="text-2xs font-extrabold uppercase text-emerald-700 dark:text-emerald-300 tracking-wider">This Week</span>
                    <h4 className="text-3xl font-extrabold text-emerald-950 dark:text-white mt-1">
                      {statsLoading ? "..." : stats?.summary.thisWeek ?? 0}
                    </h4>
                    <p className="text-xs text-emerald-800 dark:text-emerald-400 font-semibold mt-1">Guests welcomed in last 7 days</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-red-100/50 border border-red-205 dark:from-red-950/20 dark:to-red-950/10 dark:border-red-900 p-5 rounded-2xl shadow-sm">
                    <span className="text-2xs font-extrabold uppercase text-red-700 dark:text-red-300 tracking-wider">This Month</span>
                    <h4 className="text-3xl font-extrabold text-red-955 dark:text-white mt-1">
                      {statsLoading ? "..." : stats?.summary.thisMonth ?? 0}
                    </h4>
                    <p className="text-xs text-red-800 dark:text-red-400 font-semibold mt-1">Guests welcomed in last 30 days</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white border border-slate-200 dark:bg-slate-900 dark:border-slate-800/60 p-6 rounded-2xl shadow-md space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <h3 className="text-lg font-bold text-slate-950 dark:text-white">Visitor Flow (Last 15 Days)</h3>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="relative w-full h-[180px] bg-slate-50 dark:bg-slate-950/40 rounded-xl p-2 border border-slate-200/50 dark:border-slate-800/40 select-none">
                          <svg
                            ...
                            onMouseMove={(e) => handleTimelineMouseMove(e, coordinates)}
                            onMouseLeave={() => setHoveredTimelineIndex(null)}
                          >
                            <defs>
                              <linearGradient id="areaGradient" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stopColor="rgb(29, 78, 216)" stopOpacity="0.4" />
                                <stop offset="100%" stopColor="rgb(29, 78, 216)" stopOpacity="0.0" />
                              </linearGradient>
                            </defs>
                            ...
                            <line x1="20" y1="160" x2="480" y2="160" stroke="rgba(148, 163, 184, 0.3)" strokeWidth="1" />
                            <line x1="20" y1="20" x2="480" y2="20" stroke="rgba(148, 163, 184, 0.15)" strokeWidth="1" />

                            {/* Guideline for hovered point */}
                            {hoveredTimelineIndex !== null && coordinates[hoveredTimelineIndex] && (
                              <line
                            ...
                            {/* Line Path */}
                            {linePath && (
                              <path d={linePath} fill="none" stroke="rgb(29, 78, 216)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                            )}
                          ...
                          {hoveredTimelineIndex !== null && coordinates[hoveredTimelineIndex] && (
                            ...
                            >
                              ...
                              <span className="text-[9px] text-slate-500 dark:text-slate-400 font-extrabold uppercase tracking-wider">
                                {formatDate(coordinates[hoveredTimelineIndex].date)}
                              </span>
                              <span className="text-xs font-extrabold text-slate-900 dark:text-white mt-0.5 whitespace-nowrap">
                                {coordinates[hoveredTimelineIndex].count} {coordinates[hoveredTimelineIndex].count === 1 ? 'visit' : 'visits'}
                              </span>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex justify-between px-2 text-[10px] font-extrabold text-slate-700 dark:text-slate-300">
                          <span>{formatDate(stats.timelineStats[0]?.date)}</span>
                          <span>{formatDate(stats.timelineStats[Math.floor(stats.timelineStats.length / 2)]?.date)}</span>
                          <span>{formatDate(stats.timelineStats[stats.timelineStats.length - 1]?.date)}</span>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-white border border-slate-200 dark:bg-slate-900 dark:border-slate-800/60 p-6 rounded-2xl shadow-md space-y-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <h3 className="text-lg font-bold text-slate-900 dark:text-white">Visit Purpose Breakdown</h3>
                    </div>
                    ...
                    {statsLoading ? (
                      ...
                      (() => {
                        const totalPurposeCount = stats.purposeStats.reduce((sum, item) => sum + item.count, 0);
                        let currentAngle = 0;

                        const pieSlices = stats.purposeStats.map((item, idx) => {
                          const percentage = totalPurposeCount > 0 ? item.count / totalPurposeCount : 0;
                          const angleSpan = percentage * 360;
                          const startAngle = currentAngle;
                          const endAngle = currentAngle + angleSpan;
                          currentAngle = endAngle;

                          const colorObj = purposeColors[idx % purposeColors.length];
                            ...
                            <div className="relative w-44 h-44 shrink-0 flex items-center justify-center select-none">
                              <svg className="w-full h-full overflow-visible" viewBox="0 0 200 200">
                                {pieSlices.map((slice, idx) => {
                                  ...
                                  const d = getPieSlicePath(100, 100, 75, slice.startAngle, slice.endAngle);
                                  const isHovered = hoveredPieIndex === idx;
                                  ...
                                  return (
                                    <path
                                      ...
                                      style={{ 
                                        ...
                                        opacity: hoveredPieIndex !== null && !isHovered ? 0.75 : 1
                                      }}
                                ...
                                >
                                  {hoveredPieIndex !== null ? pieSlices[hoveredPieIndex].purpose : "Total Visits"}
                                </text>
                                <text
                                  x="100"
                                  y="114"
                            ...
                            <div className="w-full space-y-4 max-h-[220px] overflow-y-auto pr-1">
                              {pieSlices.map((slice, idx) => {
                                ...
                                return (
                                  <div 
                                    key={slice.purpose} 
                                    className={`space-y-1.5 transition-all duration-205 p-2 rounded-xl border border-transparent cursor-pointer ${
                                      isHovered 
                                  ...
                                  >
                                    <div className="flex items-center justify-between text-xs font-bold text-slate-900 dark:text-white">
                                      ...
                                      <span className="font-extrabold">{slice.count} ({slice.percent}%)</span>
                                    </div>
